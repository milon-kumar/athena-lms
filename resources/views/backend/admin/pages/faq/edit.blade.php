...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <form action="{{ route('admin.faq.update',$faq->id) }}" method="post" class="card border shadow">
                    @csrf
                    @method('PUT')
                    <div class="card-header text-white bg-dark">
                        ...
                        <button type="submit" class="btn btn-success btn-sm d-inline-block float-end" style="margin-right: 10px;">
                            <i class="mdi mdi-content-save"></i> Update Faq
                        </button>
                    </div>
                    <div class="card-body">
                        <div class="row mb-2">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-9">
                                <textarea name="description" id="description" cols="30" rows="5">{!! $faq->description ?? '' !!}</textarea>
                            </div>
                        </div>
                    </div>
                </form>
