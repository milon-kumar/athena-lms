...
{{--        </li>--}}
        ...
        <li class="dropdown notification-list d-none d-sm-inline-block">
            <a class="nav-link dropdown-toggle arrow-none text-white" href="{{ route('admin.dashboard') }}">
                <i class="dripicons-home noti-icon"></i>
            </a>
        </li>

        <li class="dropdown notification-list d-none d-sm-inline-block">
            <a class="nav-link dropdown-toggle arrow-none text-white" href="{{ route('frontend.home') }}" target="_blank">
            ...
            <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#"
               role="button" aria-haspopup="false" aria-expanded="false">
                <span class="account-user-avatar">
                    <img src="{{asset(Auth::user()->image) ?? defaultImage()}}"
...
{{--                </a>--}}
    ...
    <a href="{{ route('admin.dashboard') }}">
        <img style="width: 120px;height: 100%;margin-top: 5px;" src="{{ asset('/') }}frontend/images/athena_logo.png" alt="">
    </a>
</div>
