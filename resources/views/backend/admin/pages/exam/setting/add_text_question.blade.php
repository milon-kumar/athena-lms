        ...
        <div class="row">
            <div class="col-12">
                <div class="card bg-dark text-white border shadow text-center">
                    <div class="card-body">
                        <h1>{{ $title }}</h1>
                        <a href="{{ route('admin.exam.dashboard','text') }}" class="btn btn-danger btn-sm">Go Back</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="card border border-secondary">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" id="simpleinput" name="type" value="text" class="form-control">
                                    </div>
                                    ...
                                    <div class="">
                                        ...
                                        <div class="mb-3">
                                            <input type="number" class="form-control" name="passing_score" placeholder="What is the passing score ( % ) ?">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <div class="form-check form-switch">
                                                    <input type="number" name="minutes" value="anyone" class="form-control" placeholder="How much time do test takers have to complete the test?">
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <div class="form-check form-switch">
                                                    <input type="number" name="times" class="form-control" placeholder="How many times can someone take your test?">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row" id="addRowHere">
                            <div id="addCOlumn" class="col-md-12">
                                <div class="card shadow border border-secondary">
                                    <div class="card-body">
                                        <div class="mb-2">
                                            <textarea placeholder="Input Your Question" name="questions[question][q]" class="form-control" rows="1"></textarea>
                                        </div>
                                        <div class="mb-2">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="input-group mb-1">
                                                        ...
                                                        <input type="text" class="form-control" name="questions[question][option][option1]" aria-label="Option One">
                                                    </div>
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="questions[question][option][option2]" aria-label="Text input with radio button">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="input-group mb-1">
                                                        ...
                                                        <input type="text" class="form-control" name="questions[question][option][option3]" aria-label="Text input with radio button">
                                                    </div>
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="questions[question][option][option4]" aria-label="Text input with radio button">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="">
                                            <textarea placeholder="Input Your Question" name="questions[question][explanation]" class="form-control" rows="1"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group mb-1">
                                        ...
                                        <input type="text" class="form-control" name="questions[question${switchLabelName}][option][option1]" aria-label="Option One">
                                    </div>
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="questions[question${switchLabelName}][option][option2]" aria-label="Text input with radio button">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group mb-1">
                                        ...
                                        <input type="text" class="form-control" name="questions[question${switchLabelName}][option][option3]" aria-label="Text input with radio button">
                                    </div>
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="questions[question${switchLabelName}][option][option4]" aria-label="Text input with radio button">
                                    </div>
                                </div>
                            </div>
                        </div>
