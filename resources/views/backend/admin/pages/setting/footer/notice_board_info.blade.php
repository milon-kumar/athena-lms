        ...
        <div class="col-md-12">
            <form class="form-horizontal" action="{{ route('admin.setting.update') }}" method="post"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <input type="hidden" name="types[]" value="notice_board">
                        <textarea name="notice_board" id="notice_board" rows="20">{!! get_setting('notice_board') !!}</textarea>
                    </div> <!-- end card-body -->
                </div> <!-- end card-->
            </form>
        </div> <!-- end col -->
...
@section('script')
    <script>
        ClassicEditor
            .create(document.querySelector('#notice_board'))
            .catch(error => {
                console.error(error);
            });
    </script>
