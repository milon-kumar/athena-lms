        ...
        <div class="row bg-secondary">
            <div class="col-12" style="position: sticky;width: 100%;">
                <div class="page-title-box">
                    ...
                    @php
                        $post = \App\Models\Enrole::where('user_id',\Illuminate\Support\Facades\Auth::id())->where('course_id',\Illuminate\Support\Facades\Auth::user()->selected_course_id)->first();

                    @endphp
                    @if($post->is_post_approval)
                        <div class="alert alert-warning">
                            Your Suspend Form Create Community Post For Some Days. Contact Administrator.
                        </div>
                    @else
